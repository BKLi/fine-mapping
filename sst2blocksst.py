...
def SSTtoLDblock(filt_sst, chr_sst, header, distance, ldFile, prefix, group):
...
SSTtoLDblock(filt_sst=sys.argv[1], chr_sst=sys.argv[2], header=sys.argv[3], distance=int(sys.argv[4]),
             ldFile=sys.argv[5], prefix=sys.argv[6], group=sys.argv[7])
